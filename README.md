...
## 介绍 ##
一个Shell脚本，集成s5搭建，管理，启动，添加账号等基本操作。基于s5官方的辅助脚本，方便用户操作，并且支持快速构建s5服务环境。
...
## 一键安装或更新到最新 ##
 <pre><code>wget -q -N --no-check-certificate https://raw.githubusercontent.com/github.com/hanshss/dajian/master/install.sh && bash install.sh</code></pre>
